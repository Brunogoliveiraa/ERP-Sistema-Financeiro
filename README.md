...
<h1 style="color:#20B2AA;"> 📘 Sistema de Banco de Dados – ERP Sistema Financeiro</h1>
...
Este repositório contém todos os arquivos necessários para o desenvolvimento e compreensão do banco de dados da <strong>ERP Sistema Financeiro</strong>.  
O objetivo é desenvolver e praticar o que foi ensinado em aula, para que seja possivel o aluno aprender a estruturar um projeto SQL completo, utilizando boas práticas de organização de repositório, versionamento e documentação.
</p>
...
<table border="1" cellpadding="10" cellspacing="0" style="border-collapse:collapse; width:100%; text-align:center; background:#F8FFFC;">
  ...
  <tr>
    <td><strong>ERP Sistema Financeiro.db</strong></td>
...
<ol style="font-size:16px;">
  ...
  <li>Abra o arquivo <strong>ERP Sistema Financeiro.db</strong> usando:
    <ul>
      <li>SQLiteStudio</li>
